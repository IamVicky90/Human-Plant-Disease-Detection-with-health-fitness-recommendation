...
## Table of Contents.
  ...
  * [Libraries](#libraries)
  ...
  ## Demo
  Deployment Link. http://3.233.173.97:5000/ (Deployment is on Amazon Web Services).
...
2. Building deployed, and hosting a Flask web app on Amazon Web Services(AWS)( http://3.233.173.97:5000/ ).
